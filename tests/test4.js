...
const frameworks = [
    { name: 'Express', dir: '../express', port: 3001, url: 'http://localhost:3001/webp/1' },
    { name: 'Fastify', dir: '../fastify', port: 3000, url: 'http://localhost:3000/webp/1' },
    { name: 'Sails', dir: '../sails', port: 3002, url: 'http://localhost:3002/webp/1' },
    { name: 'Restify', dir: '../restify', port: 3003, url: 'http://localhost:3003/webp/1' },
    { name: 'Koa', dir: '../koa', port: 3004, url: 'http://localhost:3004/webp/1' },
    { name: 'NestJS', dir: '../nest/nest', port: 3005, url: 'http://localhost:3005/webp/1' }
];
